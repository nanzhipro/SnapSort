...
chrome_options.add_argument("--force-device-scale-factor=2")  # 强制设置2倍DPI缩放，提高分辨率
...
try:
    ...
    for html_file in html_files:
        ...
        # 保存为高质量PNG
        img.save(output_file, format='PNG', optimize=True, compress_level=0)
...
print("所有转换任务完成")
print("高清PNG图片已保存到 HTML/imgs 目录") 